...
df[[ratio_col]] <- pp_numeric_field(df[[ratio_col]], ratio_col)
df[[qvalue_col]] <- pp_numeric_field(df[[qvalue_col]], qvalue_col, minimum=.Machine$double.xmin, maximum=1)
df[[count_col]] <- pp_numeric_field(df[[count_col]], count_col)
